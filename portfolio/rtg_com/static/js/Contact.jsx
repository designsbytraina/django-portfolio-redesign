    ...
    render() {
        return (
          <div id="contact" className="row subsection-dividers d-flex align-items-stretch">
              ...
              <div className="col-xs-12 col-sm-12 col-md-5 col-lg-5" id="contact-icons-div">
                  <p>
              ...
              <div className="typeform-widget col-lg-7 col-xs-12 col-sm-12 col-md-7" id="typeform-contact" data-url="https://rachel551.typeform.com/to/KIcljG"></div><div><a href="https://www.typeform.com/examples/forms/contact-form-template/?utm_campaign=KIcljG&amp;utm_source=typeform.com-5796311-Basic&amp;utm_medium=typeform&amp;utm_content=typeform-embedded-contactform&amp;utm_term=EN" target="_blank"></a></div>
          </div>
        );
    }
}
